...
def loginSC():
	os.system('clear')
	jalan("\033[1;96mSilahkan login SC nya dulu....jangan di salah gunakan && jangan di perjaual belikan info:JIKA AKUN FB KALIAN TIDAK INGIN KENA CP SEBELUM LOGIN DI TERMUX LOGIN DLU DI OPERA MINI/BUAT FB BARU.NGERTI LU BANGSAT JANGAN BANYAK BACOT SUBSCRIBE CHANEL GW..! \n")
	...
	if username =="MESTREX" and password =="S-Tools":
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/Rafly pake i')
                time.sleep(2)
                menu()
